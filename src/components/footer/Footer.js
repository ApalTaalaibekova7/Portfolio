...
import kwork from '../../img/icons/kwork.png'; 
            ...
            <div className="container">
                <div className="footer__wrapper">
                    <ul className="social">
                        ...
                        <li className="social__item"><a href="https://www.linkedin.com/in/apal-taalaibekova-815b70324/"><img src={linkedIn} alt="Link"/></a>
                        </li>
                        <li className="social__item"><a href="https://kwork.ru/user/apaltaalaibekova7"><img src={kwork} alt="Link"/></a></li>
